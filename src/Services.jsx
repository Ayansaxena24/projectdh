      ...
      <div className="border border-gray-100 shadow-sm relative my-2 items-center justify-center h-fit w-full flex flex-col">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 grid-rows-5 md:grid-rows-2 items-center justify-center px-2 pb-8">
          ...
          <div className="flex flex-col space-y-2 items-center hover:shadow-xl px-3 my-3 pb-3 rounded-md sm:w-[100%] w-[70%] pt-4 h-[100%]">
            ...
            <p className="font-bold pt-3 text-center">3D Interior Designers</p>
          ...
          <div className="flex flex-col space-y-2 items-center hover:shadow-xl px-3 my-3 pb-3 rounded-md sm:w-[100%] w-[70%] pt-4 h-[100%]">
            ...
            <p className="font-bold pt-3 text-center">Architects For Office</p>
            <p className="text-center">
              Get your office designed in an impeccable way, contact us for the
              best architecture for your office.
            </p>
            </div>
            <div className="flex w-fit items-end h-full pb-2">
              <button
          ...
          <div className="flex flex-col space-y-2 items-center hover:shadow-xl px-3 my-3 pb-3 rounded-md sm:w-[100%] w-[70%] pt-4 h-[100%]">
            ...
            <p className="font-bold pt-3 text-center">Commercial Architects</p>
            <p className="text-center">
          ...
          <div className="flex flex-col space-y-2 items-center hover:shadow-xl px-3 my-3 pb-3 rounded-md  sm:w-[100%] w-[70%] pt-4 h-[100%]">
            ...
            <p className="text-center">
              We are professionals interior designers offering best designs for
          ...
          <div className="flex flex-col space-y-2 items-center hover:shadow-xl px-3 my-3 pb-3 rounded-md sm:w-[100%] w-[70%] pt-4 h-[100%]">
            ...
            <p className="text-center">
              We provide you with a variety of beautifully customised residences
          ...
          <div className="flex flex-col space-y-2 items-center hover:shadow-xl px-3 my-3 pb-3 rounded-md sm:w-[100%] w-[70%] pt-4 h-[100%]">
            ...
            <p className="text-center">
              Whether it's a big shopping mall or small retail outlet, we do it
              all in stipulated time period.
            </p>
            </div>
            <div className="flex w-fit items-end h-full pb-2">
              <button
