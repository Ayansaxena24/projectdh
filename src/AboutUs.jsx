  ...
  return (
    <div className="relative border-gray-100 border-2 rounded-sm">
      ...
      >
        ...
        <p className="w-[120%] lg:w-[130%] lg:text-lg md:text-lg xl:text-lg">
          We, Sthapna situated at Sodala, Jaipur, Rajasthan believe, good design is
          produced from careful study and research, combined with technical knowledge
          and artistic judgement. It is our aim to create spaces were people & activities
          thrive. Our team is capable in handling all the projects from the initial
          concept till the actual completion of the whole project.
        </p>
      </div>
    </div>
  );
