  ...
  return (
    <div>
      <MediaQuery maxWidth={412}>
        <div className="relative border-gray-100 border-2 rounded-sm flex flex-col gap-0">
          ...
          >
            <p className="relative font-bold text-4xl sm:text-2xl sm:left-6 md:text-2xl text-sm lg:text-4xl xl:text-4xl left-0 md:left-8 mb-4 lg:left-20 xl:pb-4">
              About Us
            </p>
