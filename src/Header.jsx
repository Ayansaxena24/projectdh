...
const Header = () => {
  ...
  return (
    <header className="hidden sm:visible flex flex-col sm:flex sm:flex-row sm:justify-between items-start sm:items-center pb-4 h-[15%] md:flex-row mb-4 sticky top-0 sm:right-3 sm:left-3 bg-white z-10 lg:justify-items-end bg-white">
      <div className="flex">
